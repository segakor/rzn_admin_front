...
type FieldType = TBibliotekaPosmotret;

type Props = {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  onFinish: (values: any) => void;
  initialValue?: TBibliotekaPosmotret;
};

export const FormPosmotret = ({ onFinish, initialValue }: Props) => {
  ...
  return (
    ...
    >
      ...
      <Form.Item<FieldType>
        ...
        name="linkName"
      >
        <Input placeholder="Введите название кнопки" size="large" />
      </Form.Item>
      <Form.Item<FieldType>
        label={
          <Typography.Title className="!m-0" level={5}>
      ...
      >
        <ImageUploader
          ...
          destination={fileDestination.BIBLIOTEKA_POSMOTRET}
